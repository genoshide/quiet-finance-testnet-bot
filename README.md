# Quiet Finance Testnet Automations Bot

### Description
Quiet Finance Testnet Automations Bot -- an automated Python script for interacting with platforms such as Check-in, Claim Faucet, Exchange token on Dapps, Add Liquidity, send tokens, complete missions, and Automatic Referrals.
...
1. Clone this repository:
   ```bash
   git clone https://github.com/genoshide/quiet-finance-testnet-bot.git
   cd quiet-finance-testnet-bot
   ```
